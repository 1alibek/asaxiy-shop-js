...
fetch("https://677a303e671ca03068334652.mockapi.io/products")
  ...
  .then((data) => {
    data.forEach((product) => {
      ...
      // remove product -----------------------------------------------------------------------
      const removeProductBox = document.querySelectorAll(".remove-product-box");
      ...
      const editProductBox = document.querySelectorAll(".edit-product-box");
            ...
            fetch(
              ...
              .then((product) => {
                ...
                closeForm.addEventListener("click", () => {
                  if (editFormBox.classList.contains("flex")) {
